...
modified_vectors_one_mod   <- modify_vectors_linked(shape_vectors[,1:5], color_vectors[,1:5], 1, 1:4, 1:4)
modified_vectors_two_mods  <- modify_vectors_linked(shape_vectors[,1:5], color_vectors[,1:5], 2, 1:4, 1:4)
modified_vectors_three_mods<- modify_vectors_linked(shape_vectors[,1:5], color_vectors[,1:5], 3, 1:4, 1:4)
modified_vectors_four_mods <- modify_vectors_linked(shape_vectors[,1:5], color_vectors[,1:5], 4, 1:4, 1:4)
modified_vectors_five_mods <- modify_vectors_linked(shape_vectors[,1:5], color_vectors[,1:5], 5, 1:4, 1:4)
