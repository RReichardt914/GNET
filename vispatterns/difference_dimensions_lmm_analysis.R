# This script requires the processes in the Markdown (.Rmd).
# This script was generated in response to a reviewer comment.
# How do the different dimensions relate to performance?
# Results show that in the current setup the shape dimension is dominant,
# future studies should systematically assess the effects of these dimensions.
library(ggpubr)
